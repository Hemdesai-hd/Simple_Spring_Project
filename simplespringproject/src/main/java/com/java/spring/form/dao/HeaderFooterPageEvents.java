...
//    }
    ...
    private void addHeader(PdfWriter writer) throws java.io.IOException{
//        PdfPTable header = new PdfPTable(2);
        try {
          Rectangle rect = writer.getBoxSize("art");
          ColumnText.showTextAligned(writer.getDirectContent(), Element.ALIGN_CENTER, new Phrase("Header Content"), rect.getLeft(), rect.getTop(), 0);
        	// set defaults
...
//
//            // add image
////            Image logo = Image.getInstance("C://image//gradient-logo-template-with-abstract-shape_23-2148204210.jpg");
////            header.addCell(logo);
//
//            // add text
